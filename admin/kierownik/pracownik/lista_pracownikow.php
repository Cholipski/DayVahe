...
<div class="d-flex toggled" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="lista_pracownikow.php" class="list-group-item list-group-item-action bg-light">Pracownicy</a>
    ...
    <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <h3 class="ml-auto">Panel zarządzania pracownikami</h3>
        ...
        <div class="container-fluid text-center" style="overflow-x:auto;">
            <h3 class="pt-5">Lista pracowników </h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content alert alert-danger">
            ...
            <div class="modal-body text-center">
                Czy na pewno chcesz usunąć ten pojazd?<br>
...
<script>
    ...
    $('#scrapModal').on('show.bs.modal', function (e) {
        ...
        var href = 'pracownikD.php?id=' + table
