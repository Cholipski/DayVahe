...
<head>
    ...
    <title>Day Vahe - Modyfikuj dane klienta</title>
    ...
    <div class="add-car-form-container p-4">
        <div class="card w-50 mt-5">
            <div class="card-body">
                ...
                <h3 class="card-title text-center font-weight-bold">Modyfikuj dane klienta</h3>
                ...
                <div class="card-text">
                    <form action="klientU.php" method="post">
                        ...
                        <div class="sign-up">
                            <a href="lista_klientow.php">Powrót do listy klientów</a>
                        </div>
                    </form>
                </div>
            </div>
