...
<table class="table table-bordered table-striped table-hover table-sm">
    ...
    <tr>
        <th colspan="100%"><a href="dodaj.php" class="btn btn-success">Dodaj klienta</a></th>
    </tr>
    <tr>
        <th scope="col">#</th>
    ...
    while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        echo '<tr>'.'<th scope="row" class="align-middle">'.$row['id'].'</th>'.'<td class="align-middle">'.$row['login'].'</td>'
            ...
            .'<td class="align-middle">'.$row['pesel'].'</td>'.'<td><a href="modyfikuj.php?id='.$row['id'].'" class="btn btn-warning">Edytuj</a></td>'
