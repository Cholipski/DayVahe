...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="../wyszukaj_pojazd/lista_pojazdow.php" class="list-group-item list-group-item-action bg-light">Wyszukaj pojazd</a>
            ...
            <a href="../nowy_wynajem/dodaj.php" class="list-group-item list-group-item-action bg-light">Wynajmij pojazd bez rezerwacji</a>
    ...
    <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <h3 class="ml-auto">Panel zarządzania umowami</h3>
